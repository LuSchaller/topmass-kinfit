...
def add_variables(cfg: od.Config) -> None:
    ...
    add_variable(
        ...
        null_value=EMPTY_FLOAT,
        binning=(40, -3.2, 3.2),
        x_title=r"Jet 6 $\phi^{\text{fit}}$",
    )
    add_variable(
        cfg,
        name="fitreco_Top1_mass",
        expression="RecoT1mass",
        binning=(100, 0, 500),
        unit="GeV",
        x_title=r"$m_{\text{t}_{1}}^{\text{reco}}$",
    )
    add_variable(
        cfg,
        name="fitreco_Top2_mass",
        expression="RecoT2mass",
        binning=(100, 0, 500),
        unit="GeV",
        x_title=r"$m_{\text{t}_{2}}^{\text{reco}}$",
    )
    ...
    add_variable(
        cfg,
        name="fitreco_W2_mass",
        expression="RecoW2mass",
        binning=(70, 60, 130),
        unit="GeV",
        x_title=r"$m_{\text{W}_{2}}^{\text{reco}}$",
    )
    # Coarser binned versions of kinematic parameters
    add_variable(
        cfg,
        name="coarse_jets_pt",
        expression="Jet.pt",

...
def jet_selection(
    ...
    **kwargs,
    ...
    jet6_existance = (ak.num(jet_mask0, axis=1) > 5)
    ...
    bjet_sel_alt = (ak.sum(bjet_mask, axis=1) >= 2)
    sixjets_sel = (bjet_sel_alt & (ak.sum(light_jet, axis=1) >= 4))
    ...
    mwref = 80.36
    mwsig = 11.01  # Jette: 11.01, 12
    mtsig = 27.07  # not Jette: 15
